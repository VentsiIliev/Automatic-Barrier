...
# from utils.util import get_car
#
# results = {}
#
# # mot_tracker = Sort()
...
#
# # load video
# cap = cv2.VideoCapture('assets/videos/sample2.mp4')
...
#
#             # apply thresholding
#             _, license_plate_crop_thresh = cv2.threshold(license_plate_crop_blur, 64, 255, cv2.THRESH_BINARY)
#
#             # apply morphological operations (dilation and erosion)
#             kernel = np.ones((3, 3), np.uint8)
#             license_plate_crop_dilated = cv2.dilate(license_plate_crop_thresh, kernel, iterations=1)
#             license_plate_crop_eroded = cv2.erode(license_plate_crop_dilated, kernel, iterations=1)
#
#             # apply histogram equalization
#             license_plate_crop_equalized = cv2.equalizeHist(license_plate_crop_eroded)
#
#             # read license plate number
#             license_plate_text, license_plate_text_score = util.tesseract_read_license_plate(
#                 license_plate_crop_equalized)
#
